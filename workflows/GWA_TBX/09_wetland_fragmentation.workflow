...
This step can be used to quantify landscape patterns through the calculation of various Landscape-level metrics such as mean patch size and Shannon Diversity Index.
